...
class Hotel {
  ...
  Hotel(this.name,
      {required this.reviews, required this.price, required this.rating});
}
  ...
  List<City> _cities = [
    City(
        ...
        hotels: [
          ...
          Hotel('Allegroitalia Pisa Tower Plaza',
              reviews: 128, price: 119, rating: 4),
        ]),
    City(
        name: 'Budapest',
        ...
        hotels: [
          ...
          Hotel('Golden Budapest Condominium',
              reviews: 213, price: 217, rating: 5),
        ]),
    City(
        name: 'London',
        ...
        hotels: [
          Hotel('InterContinental London Hotel',
              reviews: 1624, price: 418, rating: 3),
          Hotel('Brick Lane Hotel', reviews: 101, price: 101, rating: 4),
          Hotel('Park Villa Boutique House',
              reviews: 161, price: 128, rating: 5),
        ]),
  ];
